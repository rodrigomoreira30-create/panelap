...
import { Guitar, Drum, Piano, MicVocal, Volume2, Music } from 'lucide-react'
...
describe('getInstrumentIcon', () => {
  ...
  it('todos os 34 valores do seletor atual (InstrumentPicker) possuem mapeamento e nenhum lança erro', () => {
    const allInstruments = [
      'Acordeom', 'Órgão', 'Piano', 'Sintetizador', 'Teclado',
